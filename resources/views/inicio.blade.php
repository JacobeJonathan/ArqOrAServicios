      ...
      <div class="swiper-variant-1">
        <div class="swiper-container swiper-slider swiper-container-horizontal swiper-container-fade" data-slide-effect="fade" data-min-height="600px">
          <div class="swiper-wrapper" style="transition-duration: 600ms;">
            ...
            <div class="swiper-slide" data-slide-bg="{{asset('admin/'.$item->portada)}}" data-swiper-slide-index="1" style="background-image: url({{asset('admin/'.$item->portada)}}); background-size: cover; width: 1519px; transform: translate3d(-3038px, 0px, 0px); transition-duration: 600ms; opacity: 1;">
