...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí están todas las conexiones de base de datos configuradas para su aplicación.
    | Por supuesto, ejemplos de configuración de cada plataforma de base de datos
    | soportado por Laravel se muestra a continuación para simplificar el desarrollo.
    |
    |
    | Todo el trabajo de la base de datos en Laravel se realiza a través de las instalaciones de PHP PDO
    | así que asegúrese de tener el controlador para la base de datos particular de
    ...
    */
    ...
    | tu solicitud. Con esta información, podemos determinar cuál de
